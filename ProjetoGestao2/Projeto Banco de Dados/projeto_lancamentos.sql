...
CREATE TABLE `lancamentos` (
  ...
  `cpf_lancamentos` char(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `cpflancamento` (`cpf_lancamentos`),
  CONSTRAINT `cpflancamento` FOREIGN KEY (`cpf_lancamentos`) REFERENCES `pessoas` (`cpf`)
...
-- Dump completed on 2024-03-12 21:22:12
